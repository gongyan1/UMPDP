...
#             print("========================ch[f]", f, ch[f[0]])
            ...
            c2 = ch[f[0]]
            args = [c2]
        elif m is DMAF_SE_AFF2:
            c2 = ch[f[0]]
            args = [c2]
        elif m is DMAF_SE_AFF3:
            c2 = ch[f[0]]
            args = [c2]
        elif m is DMAF_SE_AFF4:
            c2 = ch[f[0]]
            args = [c2]
        elif m is DMAF_SE_AFF5:
            c2 = ch[f[0]]
            args = [c2]
        elif m is TN_AFF:
            c2 = ch[f[0]]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='yolov5s_DMAF_fusion_sk.yaml', help='model.yaml')
